...
DIR_SOURCE=/var/amarki/repository/microSocial/
DIR_TARGET=/var/www/microSocial/
...
sudo -uwww-data /usr/bin/php8.1 /usr/local/bin/composer26 install
...
cd ${DIR_TARGET}
sudo -uwww-data /usr/bin/php8.1 artisan migrate

echo "Reloading PHP FPM 8.1"
