...
DIR_SOURCE=/var/amarki/repository/microIntegrations/
DIR_TARGET=/var/www/microIntegrations/
...
cd ${DIR_TARGET}
echo "Syncing Files"
sudo -uwww-data rsync --progress -rt --del --exclude-from="/var/amarki/exclude_integrations" ${DIR_SOURCE} ${DIR_TARGET}
...
echo "Rereading Supervisor Configurations"
